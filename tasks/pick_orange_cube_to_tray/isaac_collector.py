"""
tasks/pick_orange_cube_to_tray/isaac_collector.py
Entry point: pick up the orange cube and place it on the tray.
"""
...
class PickOrangeCubeToTrayScene(PickAndPlaceScene):
    ...
    def scripted_action(self) -> np.ndarray:
        return self._rmpflow_pick_place_action(self.cubes["orange"], self.goal_pos)
